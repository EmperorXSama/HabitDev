...
internal static class HabitMappings
{
    public static readonly SortMappingDefinition<HabitDto, Habit> SortMapping = new()
    {
        ...
        [
            ...
            new SortMapping(
                $"{nameof(HabitDto.Frequency)}.{nameof(Frequency.Type)}",
                $"{nameof(Habit.Frequency)}.{nameof(Frequency.Type)}"
                ),
            new SortMapping(
                $"{nameof(HabitDto.Frequency)}.{nameof(Frequency.TimesPerPeriod)}",
                $"{nameof(Habit.Frequency)}.{nameof(Frequency.TimesPerPeriod)}"
            ),
            new SortMapping(
                $"{nameof(HabitDto.Target)}.{nameof(Target.Value)}",
                $"{nameof(Habit.Target)}.{nameof(Target.Value)}"
                ),
            new SortMapping(
                $"{nameof(HabitDto.Target)}.{nameof(Target.Unit)}",
            ...
            new SortMapping(nameof(HabitDto.CreatedAtUtc),nameof(Habit.CraetedAtUtc)),
    ...
    public static HabitDto ToDto(this Habit habit)
    {
        return new HabitDto
        {
            ...
            CreatedAtUtc = habit.CraetedAtUtc,
